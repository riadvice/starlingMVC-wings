package citrus.view.starlingview
{
    ...
    import com.riadvice.starlingmvc.wings.application.LemonadeEngine;
    ...
    public class AnimationSequence extends Sprite
    {
        ...
        private var _ce : LemonadeEngine;
        ...
        public function AnimationSequence( textureAtlas : *, animations : Array, firstAnimation : String, animFps : Number = 30, firstAnimLoop : Boolean = false, smoothing : String = "bilinear" )
        {
            ...
            _ce = CitrusEngine.getInstance() as LemonadeEngine;
        ...
        {
            var textureAtlas : TextureAtlas = DynamicAtlas.fromMovieClipContainer(swf, (CitrusEngine.getInstance() as LemonadeEngine).scaleFactor, 0, true, true);
