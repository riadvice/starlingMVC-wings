 ...
 */
package org.lionart.starlingmvc.wings.sound
{
    ...
    public class SoundManager extends EventDispatcher
    {
        ...
        private function addSound( linkageID : *, preloadedSound : Sound, path : String, name : String, buffer : Number = 1000, checkPolicyFile : Boolean = false ) : Boolean
        {
            ...
            {
                if ((_sounds[i] as SoundItem).name == name)
                {
                    return false;
                }
            }
            ...
            dispatcher.dispatchEvent(new SoundManagerEvent(SoundManagerEvent.SOUND_ITEM_ADDED, si));
        ...
        public function removeSound( name : String ) : void
        {
            ...
            dispatcher.dispatchEvent(new SoundManagerEvent(SoundManagerEvent.SOUND_ITEM_REMOVED, (_soundsDict[name] as SoundItem)));
        ...
        public function removeAllSounds() : void
        {
            ...
            dispatcher.dispatchEvent(new SoundManagerEvent(SoundManagerEvent.REMOVED_ALL));
        }
        ...
        public function playSound( name : String, volume : Number = 1, startTime : Number = 0, loops : int = 0, resumeTween : Boolean = true ) : void
        {
            ...
            dispatcher.dispatchEvent(new SoundManagerEvent(SoundManagerEvent.SOUND_ITEM_PLAY_START, si));
        }
        ...
        public function pauseSound( name : String, pauseTween : Boolean = true ) : void
        {
            ...
            dispatcher.dispatchEvent(new SoundManagerEvent(SoundManagerEvent.SOUND_ITEM_PAUSE, si));
        }
        ...
        public function stopSound( name : String ) : void
        {
            ...
            dispatcher.dispatchEvent(new SoundManagerEvent(SoundManagerEvent.SOUND_ITEM_STOP, si));
        }
        ...
        public function playAllSounds( resumeTweens : Boolean = true, useCurrentlyPlayingOnly : Boolean = false ) : void
        {
            ...
            dispatcher.dispatchEvent(new SoundManagerEvent(SoundManagerEvent.PLAY_ALL));
        }
        ...
        public function pauseAllSounds( pauseTweens : Boolean = true, useCurrentlyPlayingOnly : Boolean = true ) : void
        {
            ...
            dispatcher.dispatchEvent(new SoundManagerEvent(SoundManagerEvent.PAUSE_ALL));
        }
        ...
        public function stopAllSounds( useCurrentlyPlayingOnly : Boolean = true ) : void
        {
            ...
            dispatcher.dispatchEvent(new SoundManagerEvent(SoundManagerEvent.STOP_ALL));
        }
        ...
        public function fadeSound( name : String, targVolume : Number = 0, fadeLength : Number = 1, stopOnComplete : Boolean = false ) : void
        {
            ...
            dispatcher.dispatchEvent(new SoundManagerEvent(SoundManagerEvent.SOUND_ITEM_FADE, si));
        }
        ...
        public function muteAllSounds() : void
        {
            ...
            dispatcher.dispatchEvent(new SoundManagerEvent(SoundManagerEvent.MUTE_ALL));
        }
        ...
        public function unmuteAllSounds() : void
        {
            ...
            dispatcher.dispatchEvent(new SoundManagerEvent(SoundManagerEvent.UNMUTE_ALL));
        }
        ...
        private function onSoundLoadError( evt : IOErrorEvent ) : void
        {
            ...
            dispatcher.dispatchEvent(new SoundManagerEvent(SoundManagerEvent.SOUND_ITEM_LOAD_ERROR));
        }
        ...
        private function onSoundLoadProgress( evt : ProgressEvent ) : void
        {
            ...
            dispatcher.dispatchEvent(new SoundManagerEvent(SoundManagerEvent.SOUND_ITEM_LOAD_PROGRESS, _tempExternalSoundItem, duration, percent));
        }
        ...
        private function onSoundLoadComplete( evt : Event ) : void
        {
            ...
            dispatcher.dispatchEvent(new SoundManagerEvent(SoundManagerEvent.SOUND_ITEM_LOAD_COMPLETE, _tempExternalSoundItem, duration));
