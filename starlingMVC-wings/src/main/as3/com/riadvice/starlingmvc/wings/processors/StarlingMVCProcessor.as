...
package com.riadvice.starlingmvc.wings.processors
{
    ...
    public class StarlingMVCProcessor
    {
        ...
        public function processBeans( xmlBeans : XMLList, xmlCommands : XMLList, beans : Array ) : void
        {
            ...
            {
                beans.push(new Command(Wings.wings_internal::config.eventClass[node.@event], com.riadvice.starlingmvc.wings.utils.ClassUtils.findClassInPackages(node.attribute("class"), Wings.wings_internal::config.commandPackages), node.@oneTime.toString() == "true"));
            }
        }
    }
}
